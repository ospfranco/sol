...
//                  to:
//    (@convention(c)(AnyClass?,Selector?)->AnyObject).self)(_MRNowPlayingClientProtobuf,Selector("a"+"lloc"))

//        unsafeBitCast(
//            dlsym(handle, "objc_msgSend"),
//            to:(@convention(c)(AnyObject?,Selector?,Any?)->Void).self)
//            (object,Selector("i"+"nitWithData:"),
//            information["kMRMediaRemoteNowPlayingInfoClientPropertiesData"] as AnyObject?)
