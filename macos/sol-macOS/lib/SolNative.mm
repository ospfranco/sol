...
RCT_EXTERN_METHOD(pasteImageToFrontmostApp : (NSString)imagePath)
RCT_EXTERN_METHOD(deleteClipboardImage : (NSString)imagePath thumbnailPath : (NSString)thumbnailPath)
